  ...
  const handleSave = () => {
    if (selectedSnippet && hasUnsavedChanges) {
      setSnippets(snippets.map(s => 
        s.id === selectedSnippet.id ? selectedSnippet : s
      ));
      setHasUnsavedChanges(false);
    }
  };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full">
            ...
            <div className="space-y-2 dark:text-gray-200">
              <p><kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded">⌘/Ctrl + N</kbd> New snippet</p>
              <p><kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded">⌘/Ctrl + S</kbd> Save changes</p>
              <p><kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded">Esc</kbd> Clear selection</p>
              <p><kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded">Delete</kbd> Delete snippet</p>
            </div>
            <button 
        ...
        {selectedSnippet ? (
          ...
          <div className="text-center text-gray-500 dark:text-gray-400 mt-10">
            ...
            <p className="text-sm mt-2">
              Press <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded">⌘/Ctrl + N</kbd> to create a new snippet
            </p>
          </div>
        )}
      </div>
